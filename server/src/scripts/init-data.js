...
mongoose.connect("mongodb://127.0.0.1:27017/grosharies", {
  useNewUrlParser: true,
  useUnifiedTopology: true,
});
mongoose.connection
  .once("connected", () =>
    console.log("Database connected successfully for db:init")
  )
  .then(() => init())
  .finally(() =>
    mongoose
...
const init = async () => {
  try {
    ...
    const desc = [
      "Just passed by the all mighty Yochananof and saw about a few goodies left alone and ready to be eaten!",
